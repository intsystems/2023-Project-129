...
\begin{abstract}
Tensor based time series decomposition methods based on SSA showed great results in both denoising and interpretability. Several forecasting techniques based on them were already explored, yet none provided simultaneously accurate, stable and computationally cheap inferring, especially for nonstationary environment. After an in-depth study of well known models we facilitated a new one comprising all three requirements for wearable brain-computer interfaces. The model was then tested on real-life data of brain activity and corresponding arm movements.
\end{abstract}
